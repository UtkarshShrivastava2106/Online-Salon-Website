<%-- 
    Document   : blogSection.jsp
    Created on : 08-Feb-2022, 1:02:20 pm
    Author     : utkar
--%>
...
<html>
      ...
      <div class = "banner">
        <div class = "container">
          <h1 class = "banner-title">
            <span>Beauty Blogs</span>
          </h1>
          <p>everything that you want to know about salon, skin and makeover</p>
          <form>
    ...
    <section class = "design" id = "design">
      <div class = "container">
        <div class = "title">
          <h2>Recent Makeups and Haircuts</h2>
          <p>recent makeups & haircuts on the blog</p>
        </div>
    ...
    <section class = "blog" id = "blog">
      <div class = "container">
        <div class = "title">
          <h2>Latest Blog</h2>
          <p>recent blogs about skin care and beauty tips</p>
        </div>
        <div class = "blog-content">
          <!-- item -->
          <div class = "blog-item">
            <div class = "blog-img">
                <img src = "images/blogTips1.jpg" alt = "">
          ...
          <div class = "blog-item">
            <div class = "blog-img">
                <img src = "images/blogTips2.jpg" alt = "">
              <span><i class = "far fa-heart"></i></span>
            </div>
            <div class = "blog-text">
              <span>20 January, 2020</span>
          ...
          <div class = "blog-item">
            <div class = "blog-img">
                <img src = "images/blogTips3jpg.png" alt = "">
              <span><i class = "far fa-heart"></i></span>
            </div>
            <div class = "blog-text">
              <span>20 January, 2020</span>
          ...
          <div class = "blog-item">
            <div class = "blog-img">
                <img src = "images/blogTips4.jpg" alt = "">
              <span><i class = "far fa-heart"></i></span>
            </div>
            <div class = "blog-text">
              <span>20 January, 2020</span>
          ...
          <div class = "blog-item">
            <div class = "blog-img">
                <img src = "images/blogTips5.jpg" alt = "">
              <span><i class = "far fa-heart"></i></span>
            </div>
            <div class = "blog-text">
              <span>20 January, 2020</span>
          ...
          <div class = "blog-item">
            <div class = "blog-img">
                <img src = "images/blogTips6.jpg" alt = "">
              <span><i class = "far fa-heart"></i></span>
            </div>
            <div class = "blog-text">
              <span>20 January, 2020</span>
    ...
    <footer>
      ...
      <span>Shrangarika Beauty Parlor Blog Page</span>
    </footer>
    <!-- end of footer -->
